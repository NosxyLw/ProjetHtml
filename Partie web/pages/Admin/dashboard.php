...
// 3. SÉCURITÉ (RBAC) : On bloque l'accès si l'utilisateur n'est pas Admin
if (!isset($_SESSION['est_admin']) || $_SESSION['est_admin'] == 0) {
    header('Location: ../../index.php');
    exit();
}

// 4. REQUÊTES SQL (Avec Jointures simples)
// On récupère les prestations et le nom de leur catégorie
$reqPresta = $pdo->query("
...
// On récupère les séances et le nom de la prestation associée
$reqSeance = $pdo->query("
    SELECT * FROM SEANCE 
    ...
    <div class="container">
        ...
        <table border="1" width="100%" cellpadding="10" style="margin-top: 15px; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td>
                    <a href="supprimer_prestation.php?code=<?php echo $p['code_prestation']; ?>" style="color: red;">Supprimer</a>
                </td>
            </tr>
            <?php } ?>
        </table>
