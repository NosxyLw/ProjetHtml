...
<body>
    ...
    <nav>
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="deconnexion.php" class="btn btn-danger" style="margin-left: 1rem;">Déconnexion</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-label">Séances à venir</div>
            </div>
            <div class="stat-card">
        ...
        <section class="section">
            ...
            <div style="margin-top: 2rem; display: flex; gap: 1rem; flex-wrap: wrap;">
                <a href="prestations.php" class="btn btn-primary">Voir toutes les prestations</a>
                <a href="mes_reservations.php" class="btn btn-secondary">Toutes mes réservations</a>
            </div>
        </section>

        <!-- AVAILABLE PRESTATIONS -->
        <section class="section">
            <div class="section-header">
            ...
            <div class="cards-grid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-info">
                            <span class="card-info-icon">👥</span>
                            <span>15/20 places disponibles</span>
                        </div>
                        <div class="card-info">
                            <span class="card-info-icon">✅</span>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="reserver.php?code=PL-ADULTE&seance=4" class="btn btn-primary" style="padding: 0.6rem 1.2rem;">Réserver</a>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-info">
                            <span class="card-info-icon">📅</span>
                            <span>07-11 Juillet 2026</span>
                        </div>
                        <div class="card-info">
                            <span class="card-info-icon">👥</span>
                            <span>8/12 places disponibles</span>
                        </div>
                        <div class="card-info">
                            <span class="card-info-icon">✅</span>
                            <span class="badge badge-available">Disponible</span>
        ...
        <section class="section" style="background: linear-gradient(135deg, var(--noir-profond) 0%, var(--gris-beton) 100%); padding: 3rem; border: 4px solid var(--vert-terrain); margin-top: 3rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
                <a href="prestations.php" class="btn btn-primary" style="padding: 1.2rem; text-align: center;">
                    🏟 Réserver une séance
                </a>
                <a href="mes_reservations.php" class="btn btn-secondary" style="padding: 1.2rem; text-align: center;">
                    📋 Mes réservations
                </a>
                <a href="profil.php" class="btn btn-secondary" style="padding: 1.2rem; text-align: center;">
                    ⚙️ Mon profil
                </a>
                <a href="historique.php" class="btn btn-secondary" style="padding: 1.2rem; text-align: center;">
                    📊 Mon historique
                </a>
            </div>
        </section>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h3>Navigation</h3>
                <p><a href="dashboard.php">Mon espace</a></p>
                <p><a href="prestations.php">Prestations</a></p>
                <p><a href="mes_reservations.php">Mes réservations</a></p>
            </div>
            <div class="footer-section">
                <h3>Contact</h3>
